...
public interface IRecordsService
{
    ...
    /// <returns></returns>
    Task<RecordTable> CreateRecord(long customerId, string time, DateTime date, int place, long stateId);
    ...
    Task<RecordTable[]> GetRecordsByFilter(int page, int perPage, DateTime dateFrom, DateTime dateTo, long stateId = 0, long customerId = 0);
    ...
    Task<RecordTable> GetRecord(long recordId);
    ...
    Task<RecordTable> UpdateRecord(RecordTable newRecord);
}
